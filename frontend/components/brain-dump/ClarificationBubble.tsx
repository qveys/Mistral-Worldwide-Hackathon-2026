...
export function ClarificationBubble({
  ...
  return (
    <div className={cn("fixed bottom-8 left-1/2 -translate-x-1/2 z-[60] w-full max-w-xl px-4", className)}>
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-4">
                <div className="space-y-1">
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-400">Précision requise</span>
                ...
                <form onSubmit={handleSubmit} className="relative group">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      answer.trim() ? "bg-blue-600 text-white shadow-lg" : "text-slate-600 cursor-not-allowed"
                    )}
                  >
                    <Send size={18} />
                  </button>
