            ...
            <AnimatePresence mode="wait">
                {!isProcessing ? (
                    ...
                    >
                        ...
                        {/* Main Input Zone */}
                        <div className="relative min-h-50 mb-6">
                            {/* STT Error Banner */}
                            {sttError && (
                                <motion.div
                            ...
                            {micState === 'recording' ? (
                                ...
                                <div className="relative group">
                                    <textarea
                                        ...
                                        placeholder=""
                                        className="w-full min-h-50 bg-transparent border-none focus:ring-0 text-xl text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-600 resize-none"
                                    />
