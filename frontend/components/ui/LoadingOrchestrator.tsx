...
import { Loader2, Sparkles, Brain, FileText, CheckCircle2, XCircle, Clock } from 'lucide-react';
      ...
      <div className="flex flex-col items-center gap-10 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="h-20 w-20 rounded-3xl bg-blue-600 flex items-center justify-center shadow-2xl shadow-blue-500/40 ring-4 ring-blue-500/20">
            <AnimatePresence mode="wait">
              ...
              >
                {React.createElement(currentStep.icon, { className: "text-white h-10 w-10" })}
              </motion.div>
            </AnimatePresence>
          </div>
        </div>
        ...
        <div className="w-full space-y-4">
          ...
          <div className="flex justify-between items-center px-1">
             ...
             <span className="text-[10px] font-black uppercase tracking-widest text-blue-500">{Math.round(progress)}%</span>
          </div>
        </div>
           ...
           {LOADING_STEPS.map((step, i) => (
             <div 
              ...
              className={cn(
                ...
                currentStepIndex >= i ? "bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]" : "bg-slate-200 dark:bg-white/5"
              )} 
             />
           ))}
        </div>
