    ...
    <div className="min-h-screen bg-[#fafafa] text-slate-900 flex flex-col font-sans selection:bg-orange-100 selection:text-orange-900 overflow-x-hidden">
      ...
      <nav className="p-8 flex justify-between items-center max-w-7xl mx-auto w-full relative z-20">
        ...
        <div className="flex items-center gap-2 text-sm font-medium text-slate-500">
          <a href="/documentation?category=methodology" className="px-4 py-2 rounded-full hover:bg-slate-100 hover:text-black transition-all duration-300">Methodology</a>
          ...
          <a href="/documentation?category=api" className="px-4 py-2 rounded-full hover:bg-slate-100 hover:text-black transition-all duration-300">API</a>
