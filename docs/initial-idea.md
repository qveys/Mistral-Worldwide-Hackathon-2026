...
**Chaos to Clarity** prend un _brain dump_ vocal ou textuel désorganisé et le transforme en une **roadmap structurée**, une **liste de tâches prioritaires et un planning clair** en temps réel.  
...
- **Input**
    - Enregistrement audio (Voxtral) ou saisie texte
...
- [] CRUD utilisateurs
- [] Appels à Voxtral AI pour le voice to text
