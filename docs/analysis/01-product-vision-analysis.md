...
- Différenciation technique visible : ElevenLabs STT + Mistral Large + révision conversationnelle
...
- **[MED]** Dépendance à deux services tiers critiques sans fallback (ElevenLabs + Bedrock)
...
1. Pipeline voix → texte transcrit visible en temps réel (ElevenLabs WebSocket)
...
- Seule option qui crée un effet visuel *pendant* le discours
