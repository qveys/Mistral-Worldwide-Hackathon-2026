...
const RECENT_PROJECT_KEYS = [
    {
        id: '1',
        titleKey: 'recentProject1Title',
        statusKey: 'statusStable',
        lastEditKey: 'lastEdit2m',
        nodes: 24,
    },
    {
        id: '2',
        titleKey: 'recentProject2Title',
        statusKey: 'statusReview',
        lastEditKey: 'lastEdit1h',
        nodes: 12,
    },
    {
        id: '3',
        titleKey: 'recentProject3Title',
        statusKey: 'statusDraft',
        lastEditKey: 'lastEdit4h',
        nodes: 18,
    },
    {
        id: '4',
        titleKey: 'recentProject4Title',
        statusKey: 'statusStable',
        lastEditKey: 'lastEdit1d',
        nodes: 32,
    },
] as const;
