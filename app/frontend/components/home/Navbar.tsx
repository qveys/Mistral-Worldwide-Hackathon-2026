  ...
  return (
    <nav className="pt-12 pb-8 px-8 flex justify-between items-center max-w-7xl mx-auto w-full relative z-20">
      ...
      <div className="flex items-center gap-2 text-sm font-medium text-slate-500">
        ...
        <a href="https://github.com/qveys/Mistral-Worldwide-Hackathon-2026" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="p-2 rounded-full hover:bg-slate-200 hover:text-slate-900 transition-all duration-300">
          <Github size={20} />
        </a>
      </div>
    </nav>
