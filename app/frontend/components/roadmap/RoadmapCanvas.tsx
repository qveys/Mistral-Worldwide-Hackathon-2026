...
/** Simple item card used in wrapper/children mode */
export function RoadmapItem({
    ...
    return (
        <div className="p-4 rounded-2xl bg-white/40 dark:bg-black/40 backdrop-blur-md border border-white/20 dark:border-white/10 shadow-sm">
            <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                    {period && (
                        <span className="px-2 py-1 rounded-lg text-[10px] font-bold uppercase bg-white/50 dark:bg-white/5 border border-white/20 text-slate-500">
                            {period}
                        </span>
                    )}
                    {status && (
...
export function RoadmapCanvas({
    ...
    // Wrapper mode: render title + children
    if (!roadmap && (title || children)) {
        return (
            ...
            >
                ...
                {roadmap.timeSlots.map((slot, slotIdx) => (
                    ...
                    >
                        ...
                        >
                            {slot.tasks.map((task) => {
                                const objective = roadmap.objectives.find(
