    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {objectives.map((obj) => {
          ...
          return (
            <div key={obj.id} className="bg-[#161618] border border-zinc-800/50 rounded-[2rem] p-6 hover:border-blue-500/30 transition-all group">
              ...
              <h4 className="text-lg font-bold text-white group-hover:text-blue-400 transition-colors leading-tight mb-2">{obj.text}</h4>
              <div className="mt-6 flex flex-col gap-1.5">
                ...
                <div className="w-full h-1 bg-zinc-800 rounded-full overflow-hidden">
                  <div className="h-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.4)]" style={{ width: `${progress}%` }} />
                </div>
              </div>
            </div>
          );
