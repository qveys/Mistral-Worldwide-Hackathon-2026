  ...
  return (
    <div className={cn(
      ...
      <div className="relative w-full sm:w-96 group">
        <Search size={16} className={cn("absolute left-4 top-1/2 -translate-y-1/2 group-focus-within:text-[#536dfe] transition-colors", isDarkMode ? "text-zinc-600" : "text-slate-500")} />
        <input 
          type="text" 
