 ...
 */
export async function structureController(req, res) {
    ...
    try {
        ...
        try {
            ...
            const retryPrompt = buildRetryPrompt(jsonStr, zodError instanceof ZodError ? zodError.message : String(zodError));
